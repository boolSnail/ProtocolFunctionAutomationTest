    ...
    namespace PROTOCOL104
    {
        ...
        {   
            public static int EncodeFrame(byte dataty)
            {
                ...
                if (dataty == 1)     //启动传输
                {
                    GlobeData.StremData.data[Leng++] = 0x68;  //起始字节
                    GlobeData.StremData.data[Leng++] = 0x04;  //长度
                    GlobeData.StremData.data[Leng++] = 0x07;  // 控制域第一字节00000111---STARTDTact=1；U格式报文
                    GlobeData.StremData.data[Leng++] = 0x00;
                    GlobeData.StremData.data[Leng++] = 0x00;
                    GlobeData.StremData.data[Leng++] = 0x00;
                ...
                {
                    GlobeData.StremData.data[Leng++] = 0x68;
                    GlobeData.StremData.data[Leng++] = 0x04;
                    GlobeData.StremData.data[Leng++] = 0x0B; // 控制域第一字节00001011---STARTDTcon=1；U格式报文
                    GlobeData.StremData.data[Leng++] = 0x00;
                    GlobeData.StremData.data[Leng++] = 0x00;
                    GlobeData.StremData.data[Leng++] = 0x00;
                }
                else if (dataty == 3)  //停止命令
                {
                    GlobeData.StremData.data[Leng++] = 0x68;
                    GlobeData.StremData.data[Leng++] = 0x04;
                    GlobeData.StremData.data[Leng++] = 0x13; // 控制域第一字节00010011---STOPDTact=1；U格式报文
                    GlobeData.StremData.data[Leng++] = 0x00;
                    GlobeData.StremData.data[Leng++] = 0x00;
                    GlobeData.StremData.data[Leng++] = 0x00;
                    //PublicDataClass.OutPutMessage.S_type = 1;
                ...
                else if (dataty == 4)  //停止确认 一般从站发送
                {
                    GlobeData.StremData.data[Leng++] = 0x68;
                    GlobeData.StremData.data[Leng++] = 0x04;
                    GlobeData.StremData.data[Leng++] = 0x23; // 控制域第一字节00100011---STOPDTcon=1；U格式报文
                    GlobeData.StremData.data[Leng++] = 0x00;
                    GlobeData.StremData.data[Leng++] = 0x00;
                    GlobeData.StremData.data[Leng++] = 0x00;
                }
                else if (dataty == 5)  //测试命令
                {
                    GlobeData.StremData.data[Leng++] = 0x68;
                    GlobeData.StremData.data[Leng++] = 0x04;
                    GlobeData.StremData.data[Leng++] = 0x43; // 控制域第一字节01000011---TESTFRact=1；U格式报文
                    GlobeData.StremData.data[Leng++] = 0x00;
                    GlobeData.StremData.data[Leng++] = 0x00;
                    GlobeData.StremData.data[Leng++] = 0x00;
                    //PublicDataClass.OutPutMessage.S_type = 1;
                ...
                else if (dataty == 6)  //测试确认
                {
                    GlobeData.StremData.data[Leng++] = 0x68;
                    GlobeData.StremData.data[Leng++] = 0x04;
                    GlobeData.StremData.data[Leng++] = 0x83; // 控制域第一字节10000011---TESTFRcon=1；U格式报文
                    GlobeData.StremData.data[Leng++] = 0x00;
                    GlobeData.StremData.data[Leng++] = 0x00;
                    GlobeData.StremData.data[Leng++] = 0x00;
                }
                ...
                else if (dataty == 7)  //S格式确认帧
                {
                    GlobeData.StremData.data[Leng++] = 0x68;
                    GlobeData.StremData.data[Leng++] = 0x04;
                    GlobeData.StremData.data[Leng++] = 0x01; // 控制域第一字节00000001---S格式报文
                    GlobeData.StremData.data[Leng++] = 0x00;
                    GlobeData.StremData.data[Leng++] = (byte)(GlobeData.RxSeq & 0x00ff);  //应该为Rxseq
                    GlobeData.StremData.data[Leng++] = (byte)((GlobeData.RxSeq & 0xff00) >> 8);
                    GlobeData.W = 0;
             ...
             //   }
                ...
                else
                {
                    ...
                    GlobeData.StremData.data[6] = TypeID;
                    GlobeData.StremData.data[7] = (byte)(GlobeData.InformationObject.VSQ);
                    GlobeData.StremData.data[8] = (byte)(COT & 0x00ff);
                    GlobeData.StremData.data[9] = (byte)((COT & 0xff00) >> 8);
                    GlobeData.StremData.data[10] = (byte)((GlobeData.LinkPara.DevAddr) & 0x00ff);
                    GlobeData.StremData.data[11] = (byte)(((GlobeData.LinkPara.DevAddr) & 0xff00) >> 8);
                    ...
                    { 
                        case 100:        //总召唤
                            ...
                            GlobeData.StremData.data[Leng++] = 0x00;
                            GlobeData.StremData.data[Leng++] = 0x00;
                            GlobeData.StremData.data[Leng++] = 0x14;
                            GlobeData.TxSeq += 2;
                        ...
                        //    break;
                        case 45:   //不带时标单点控制
                            GlobeData.StremData.data[Leng++] = (byte)((GlobeData.YkStartPos) & 0x00ff);
                            GlobeData.StremData.data[Leng++] = (byte)(((GlobeData.YkStartPos) & 0xff00) >> 8);
                            GlobeData.StremData.data[Leng++] = 0x00;
                            for (int i = 0; i < GlobeData.InformationObject.Len; i++)
                                GlobeData.StremData.data[Leng++] = GlobeData.InformationObject.Buffer[i];
                            GlobeData.TxSeq += 2;
                            if (GlobeData.TxSeq >= 0x7fff)
                                GlobeData.TxSeq = 0;
                            break;
                    ...
                    GlobeData.StremData.data[1] = (byte)(Leng - 2); 
                }
            ...
            public static byte DecodeFrame()
            {
                ...
                byte AFN = 0;
                byte PN = 0;
                if ( GlobeData.StremData.recLen - GlobeData.StremData.recData[1] != 2)  //非法帧
                {
                    dataty = 0;   //非法帧
                    //dataty = 150;   //非法帧,启动字符及数据长度错误
                    #region Debug
                    GlobeData.errorStr = "启动字符及数据长度错误";
                    #endregion
                    
                }
                else if ((GlobeData.StremData.recData[0] != 0x68) || (GlobeData.StremData.recLen < 6))  //非法帧
                {
                    //dataty = 0;   //非法帧
                    dataty =150;   //非法帧,启动字符及数据长度错误
                    #region Debug
                ...
                else if ((GlobeData.StremData.recData[0] == 0x68) && (GlobeData.StremData.recLen == 6))//固定帧
                {
                    //PublicDataClass.OutPutMessage.type = 1;
                    if (GlobeData.StremData.recData[2] == 0x0b)
                    {
                        dataty = 1;  //启动确认
                        //PublicDataClass.OutPutMessage.type = 1;//U帧
                    }
                    else if (GlobeData.StremData.recData[2] == 0x83)
                    {
                        dataty = 2;  //测试确认
                        //PublicDataClass.OutPutMessage.type = 1;//U帧
                    }
                    else if (GlobeData.StremData.recData[2] == 0x23)
                    {
                        dataty = 3;  //停止确认
                        //PublicDataClass.OutPutMessage.type = 1;//U帧
                    }
                    else if (GlobeData.StremData.recData[2] == 0x01)
                    {
                        dataty = 9;  //S确认帧
                    ...
                    else
                    {
                        ...
                        #region Debug
                        GlobeData.errorStr = "非法帧固定帧控制域无效";
                        #endregion
                    }
                                        
                }

                else if ((GlobeData.StremData.recData[0] == 0x68) && (GlobeData.StremData.recLen>= 15))//可变帧
                {
                    //PublicDataClass.OutPutMessage.type = 2;
                    Length = GlobeData.StremData.recData[1];
                    txseq = (GlobeData.StremData.recData[3] << 8) + GlobeData.StremData.recData[2];
                    rxseq = (GlobeData.StremData.recData[5] << 8) + GlobeData.StremData.recData[4];
                    TypeID = GlobeData.StremData.recData[6];
                    GlobeData.InformationObject.recVSQ = GlobeData.StremData.recData[7] & 0x7f;
                   // COT = Convert.ToUInt16((PublicDataClass._NetStructData.NetRBuffer[9] << 8) + PublicDataClass._NetStructData.NetRBuffer[8]);
                    GlobeData.InfoAddr = Convert.ToInt32((GlobeData.StremData.recData[14] << 16) + (GlobeData.StremData.recData[13] << 8) + GlobeData.StremData.recData[12]);
//注意这一条！                    
                    COI = GlobeData.StremData.recData[15];
//注意这一条！
                    PN = (byte)(GlobeData.StremData.recData[8] & 0x40);//01000000
                    COT = Convert.ToUInt16(GlobeData.StremData.recData[8] & 0x3f);//00111111
                    if (txseq != GlobeData.RxSeq)
                    {
                        //dataty = 0;   //非法帧
                        dataty = 152;   //非法帧，发送序列号错误
                        //PublicDataClass._NetTaskFlag.C_RQ_NA_LINKREQ_F = true;
                        #region Debug
                        GlobeData.errorStr = "非法帧，发送序列号错误";
                        #endregion
                        goto END;
                    }
                    else
                    {
                        ...
                        #region Debug
                        System.Diagnostics.Debug.WriteLine("(104)W: " + GlobeData.W);
                        //System.Diagnostics.Debug.WriteLine("(104)len: " + GlobeData.StremData.len);
                        //System.Diagnostics.Debug.WriteLine("(104)len_data[1]: " + GlobeData.StremData.data[1]);
                        //System.Diagnostics.Debug.WriteLine("(104)Judge: " + ((GlobeData.StremData.data[0] == 0x68) && (GlobeData.StremData.len >= 15)));
                        #endregion

                        if (GlobeData.W == 8)   //确认帧的
                        {
                            GlobeData.W = 0;
            ...
            //                break;
                        case 9:               //遥测 归一化值 2+1字节
                            ...
                            for (int i = 0; i < GlobeData.StremData.recLen - 12; i++)
                                    GlobeData.InformationObject.recBuffer[i] = GlobeData.StremData.recData[i + 12];
                                GlobeData.InformationObject.recLen = GlobeData.StremData.recLen - 12;
